...
class BackgroundPainter extends CustomPainter {
  ...
  BackgroundPainter()
      : bluePaint = Paint()..color = Colors.green..style = PaintingStyle.fill,
        greyPaint = Paint()..color = Colors.lightBlueAccent..style = PaintingStyle.fill,
        orangePaint = Paint()..color = Colors.orangeAccent..style = PaintingStyle.fill,
        linePaint = Paint()..color = Colors.orange..style = PaintingStyle.stroke..strokeWidth = 4;
